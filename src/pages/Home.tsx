  ...
  return (
    <DashboardLayout pageTitle="Dashboard">
      <div className="space-y-8">
        <div>
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Welcome to DBManager</h1>
          <p className="text-lg text-gray-600">Manage your database and users efficiently.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link to="/resources/add">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Add Resource</h3>
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">View competition metrics</p>
                </div>
          ...
          <Link to="/framework">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Framework</h3>
                  <p className="text-sm text-gray-600">Configure settings</p>
                </div>
